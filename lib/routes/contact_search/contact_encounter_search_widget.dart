...
import 'contact_search_bloc.dart';

class ContactEncounterSearchWidget extends StatefulWidget {
  ContactEncounterSearchWidget({Key key}) : super(key: key);
...
class _ContactSelectionSearchWidgetState
    extends State<ContactEncounterSearchWidget> {
