...
class EncounteredContactEntryWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GestureDetector(
        onTap: () => _showContactCard(context, this.encounteredContact),
        child: Hero(
          tag: 'contact-card' + this.encounteredContact.contactIdentifier,
          child: Material(
            color: Colors.white,
  ...
  _showContactCard(BuildContext context, EncounteredContact contact) {
    Navigator.of(context).push(new PageRouteBuilder(
      opaque: false,
      barrierDismissible: true,
      barrierColor: Colors.black26,
      pageBuilder: (_, __, ___) => ContactCardDialog(contact: contact),
    ));
  }
}
